...
tf.flags.DEFINE_string("positive_data_file", "./data/weibo-remark/train/pos.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/weibo-remark/train/neg.txt", "Data source for the negative data.")
...
sentences, max_document_length = data_helpers.padding_sentences(x_text, '<PADDING>', 300)
